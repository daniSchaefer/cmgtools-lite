...
varName = {'mVV':'Dijet invariant mass [GeV]','mJ':'%sm_{jet1} [GeV]'%postfix}
...
def doAll():
    ...
    frame.Draw()
    leg.Draw("same")
    #pt =ROOT.TPaveText(0.71,0.450,0.84,0.76,"brNDC")
    #pt.SetBorderSize(0)
    #pt.SetTextAlign(12)
    #pt.SetFillStyle(0)
    #pt.SetTextFont(42)
    ...
    #pt2.AddText("m_{jj} > 1126 GeV")
    #pt2.AddText("|#Delta #eta_{jj}| < 1.3")
    #pt2.AddText("55 < m_{jet} < 215 GeV")
    pt2.Draw()
