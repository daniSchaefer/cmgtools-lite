...
def doMJFit():
	...
	for var in vars:
		...
		gHPLP.GetXaxis().SetRangeUser(1000., 5000.)
                ...
                if var.find("n2")!=-1: gHPLP.GetYaxis().SetRangeUser(0., 3.)
		if var.find("n")!=-1: gHPLP.GetYaxis().SetRangeUser(1., 10.)
		if var.find("alpha2")!=-1: gHPHP.GetYaxis().SetRangeUser(1, 10.)
		if var.find("alpha")!=-1: gHPLP.GetYaxis().SetRangeUser(0.1, 2.)
		...
		if var.find("sigma")!=-1: gHPLP.GetYaxis().SetRangeUser(0,0.3)
		if var.find("mean")!=-1: gHPLP.GetYaxis().SetRangeUser(0, 3)
		if var.find("meanZ")!=-1: gHPLP.GetYaxis().SetRangeUser(0,3)
