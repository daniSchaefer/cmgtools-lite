...
def do2DKernel(f):
	...
	l.Draw("same")
	c.SaveAs(outdir+"2DKernel/projY_mass_allmvvbins.png")
	...
	l.Draw("same")
	c.SaveAs(outdir+"2DKernel/projX_mvv_allmassbins.png")
	...
	for bin in range(1,fromKernel.GetNbinsX()):
		...
		l.Draw("same")
		c.SaveAs(outdir+"2DKernel/projY_perBin/projY_mass_mvvbin%i.png"%bin)
	...
	for bin in range(2,fromKernel.GetNbinsY()):
		...
		l.Draw("same")
		c.SaveAs(outdir+"2DKernel/projX_perBin/projX_mvv_massbin%i.png"%bin)
