...
import math
import CMS_lumi
from runFitPlots_vjets_signal_bigcombo_splitRes import get_canvas, get_pad, getListFromRange, getListOfBins, getListOfBinsLowEdge, getListOfBinsWidth, reduceBinsToRange, addPullPlot, addRatioPlot
...
def doZprojection(pdfs,data1,norm1_nonres,norm1_Wres,pdf1_sig,norm1_sig,norm1_Zres,norm1_TThad):
    ...
    for i in range(0,len(pdfs)):
        for zk,zv in zBins_redux.iteritems():
           if "nonRes" in str(pdfs[i].GetName()) in str(pdfs[i].GetName()): h[i].Fill(zv,lv[i][zv]*norm1_nonres[0])
	   elif "Wjet" in str(pdfs[i].GetName()) in str(pdfs[i].GetName()): h[i].Fill(zv,lv[i][zv]*norm1_Wres[0])
	   elif "Zjet" in str(pdfs[i].GetName()) in str(pdfs[i].GetName()): h[i].Fill(zv,lv[i][zv]*norm1_Zres[0])
	   elif "TThad" in str(pdfs[i].GetName()) in str(pdfs[i].GetName()): h[i].Fill(zv,lv[i][zv]*norm1_TThad[0])
	   else: h[i].Fill(zv,lv[i][zv]*(norm1_Wres[0]+norm1_Zres[0]+norm1_TThad[0]+norm1_nonres[0]))
    ...
    errors = draw_error_band(htot,norm1_nonres[0]+norm1_Wres[0]+norm1_Zres[0]+norm1_TThad[0],math.sqrt(norm1_nonres[1]*norm1_nonres[1]+norm1_Wres[1]*norm1_Wres[1]+norm1_Zres[1]*norm1_Zres[1]+norm1_TThad[1]*norm1_TThad[1]),pdfs[-1],zBinslowedge,'z')
...
def doXprojection(pdfs,data1,norm1_nonres,norm1_Wres,pdf1_sig,norm1_sig,norm1_Zres,norm1_TThad):
    ...
    for i in range(0,len(pdfs)):
        for xk,xv in xBins_redux.iteritems():
           if "nonRes" in str(pdfs[i].GetName()) in str(pdfs[i].GetName()): h[i].Fill(xv,lv[i][xv]*norm1_nonres[0])
	   elif "Wjet" in str(pdfs[i].GetName()) in str(pdfs[i].GetName()): h[i].Fill(xv,lv[i][xv]*norm1_Wres[0])
	   elif "Zjet" in str(pdfs[i].GetName()) in str(pdfs[i].GetName()): h[i].Fill(xv,lv[i][xv]*norm1_Zres[0])
	   elif "TThad" in str(pdfs[i].GetName()) in str(pdfs[i].GetName()): h[i].Fill(xv,lv[i][xv]*norm1_TThad[0])
...
def doYprojection(pdfs,data1,norm1_nonres,norm1_Wres,pdf1_sig,norm1_sig,norm1_Zres,norm1_TThad):
    ...
    for i in range(0,len(pdfs)):
        for yk,yv in yBins_redux.iteritems():
           if "nonRes" in str(pdfs[i].GetName()) in str(pdfs[i].GetName()): h[i].Fill(yv,lv[i][yv]*norm1_nonres[0])
	   elif "Wjet" in str(pdfs[i].GetName()) in str(pdfs[i].GetName()): h[i].Fill(yv,lv[i][yv]*norm1_Wres[0])
	   elif "Zjet" in str(pdfs[i].GetName()) in str(pdfs[i].GetName()): h[i].Fill(yv,lv[i][yv]*norm1_Zres[0])
	   elif "TThad" in str(pdfs[i].GetName()) in str(pdfs[i].GetName()): h[i].Fill(yv,lv[i][yv]*norm1_TThad[0])
...
if __name__=="__main__":
     ...
     data_all.Print()
     data1 = workspace.data("data_obs").reduce("CMS_channel==CMS_channel::JJ_"+purity+"_13TeV_"+year)
     print
     print "Observed number of events in",purity,"category:",data1.sumEntries()
     args  = model.getComponents()
     
     pdf1Name = "pdf_binJJ_"+purity+"_13TeV_"+year+"_bonly"
     
     if options.fitSignal:
      pdf1Name = "pdf_binJJ_"+purity+"_13TeV_"+year
     
     print "Expected number of QCD events:",(args[pdf1Name].getComponents())["n_exp_binJJ_"+purity+"_13TeV_"+year+"_proc_nonRes"].getVal()
     print "Expected number of W+jets events:",(args[pdf1Name].getComponents())["n_exp_binJJ_"+purity+"_13TeV_"+year+"_proc_Wjets"].getVal()
     print "Expected number of Z+jets events:",(args[pdf1Name].getComponents())["n_exp_binJJ_"+purity+"_13TeV_"+year+"_proc_Zjets"].getVal()
     
     qcd_exp        = (args[pdf1Name].getComponents())["n_exp_binJJ_"+purity+"_13TeV_"+year+"_proc_nonRes"].getVal()
     wjets_exp      = (args[pdf1Name].getComponents())["n_exp_binJJ_"+purity+"_13TeV_"+year+"_proc_Wjets"].getVal()
     zjets_exp      = (args[pdf1Name].getComponents())["n_exp_binJJ_"+purity+"_13TeV_"+year+"_proc_Zjets"].getVal()
    
     
     
     if options.addTop:
       print "Expected number of tt events:",(args[pdf1Name].getComponents())["n_exp_binJJ_"+purity+"_13TeV_"+year+"_proc_TThad"].getVal()
     if options.fitSignal:
      ...
      print "Expected signal yields:",(args[pdf1Name].getComponents())["n_exp_final_binJJ_"+purity+"_13TeV_"+year+"_proc_"+signalName+""].getVal()
     ...
     pdf1_nonres_shape_postfit  = args["shapeBkg_nonRes_JJ_"+purity+"_13TeV_"+year]
     pdf1_nonres_shape_postfit.Print()
     pdf1_nonres_shape_postfit.funcList().Print()
     pdf1_nonres_shape_postfit.coefList().Print()
     print
     
     print "Postfit W+jets res pdf:"
     pdf1_Wres_shape_postfit  = args["shapeBkg_Wjets_JJ_"+purity+"_13TeV_"+year]
     pdf1_Wres_shape_postfit.Print()
     
     print "Postfit Z+jets res pdf:"
     pdf1_Zres_shape_postfit  = args["shapeBkg_Zjets_JJ_"+purity+"_13TeV_"+year]
     pdf1_Zres_shape_postfit.Print()
     
     if options.addTop:
        print " Postfit tt res pdf:"
        pdf1_TThad_shape_postfit  = args["shapeBkg_TThad_JJ_"+purity+"_13TeV_"+year]
        pdf1_TThad_shape_postfit.Print()
       
     pdf1_signal_postfit = 0
     if options.fitSignal:
      print "2016 Signal pdf:"     
      pdf1_signal_postfit  = args["shapeSig_"+signalName+"_JJ_"+purity+"_13TeV_"+year]
  ...
  #dummy, not used
     ...
     print
     (args[pdf1Name].getComponents())["n_exp_binJJ_"+purity+"_13TeV_"+year+"_proc_nonRes"].dump()     
     norm1_nonres = [0,0]
     norm1_nonres[0] = (args[pdf1Name].getComponents())["n_exp_binJJ_"+purity+"_13TeV_"+year+"_proc_nonRes"].getVal()
     norm1_nonres[1] = (args[pdf1Name].getComponents())["n_exp_binJJ_"+purity+"_13TeV_"+year+"_proc_nonRes"].getPropagatedError(fitresult)
    
                
     print
     (args[pdf1Name].getComponents())["n_exp_binJJ_"+purity+"_13TeV_"+year+"_proc_Wjets"].dump()
     norm1_Wres = [0,0]
     norm1_Wres[0] = (args[pdf1Name].getComponents())["n_exp_binJJ_"+purity+"_13TeV_"+year+"_proc_Wjets"].getVal()
     norm1_Wres[1] = (args[pdf1Name].getComponents())["n_exp_binJJ_"+purity+"_13TeV_"+year+"_proc_Wjets"].getPropagatedError(fitresult)
    
      
       
     print
     (args[pdf1Name].getComponents())["n_exp_binJJ_"+purity+"_13TeV_"+year+"_proc_Zjets"].dump()
     norm1_Zres = [0,0]
     norm1_Zres[0] = (args[pdf1Name].getComponents())["n_exp_binJJ_"+purity+"_13TeV_"+year+"_proc_Zjets"].getVal()
     norm1_Zres[1] = (args[pdf1Name].getComponents())["n_exp_binJJ_"+purity+"_13TeV_"+year+"_proc_Zjets"].getPropagatedError(fitresult)
     print
     ...
     if options.addTop:
      print
      (args[pdf1Name].getComponents())["n_exp_binJJ_"+purity+"_13TeV_"+year+"_proc_TThad"].dump()
      norm1_TThad = [0,0]
      norm1_TThad[0] = (args[pdf1Name].getComponents())["n_exp_binJJ_"+purity+"_13TeV_"+year+"_proc_TThad"].getVal()
      norm1_TThad[1] = (args[pdf1Name].getComponents())["n_exp_binJJ_"+purity+"_13TeV_"+year+"_proc_TThad"].getPropagatedError(fitresult)
     ...
     if options.fitSignal:
      ...
      norm1_sig = [0,0]
      norm1_sig[0] = (args[pdf1Name].getComponents())["n_exp_final_binJJ_"+purity+"_13TeV_"+year+"_proc_"+signalName+""].getVal()
      norm1_sig[1] = (args[pdf1Name].getComponents())["n_exp_final_binJJ_"+purity+"_13TeV_"+year+"_proc_"+signalName+""].getPropagatedError(fitresult)
      print
     
                
     print
     print "QCD normalization after fit: ",norm1_nonres[0],"+/-",norm1_nonres[1]
     print "W+jets normalization after fit: ",norm1_Wres[0],"+/-",norm1_Wres[1]
     print "Z+jets normalization after fit: ",norm1_Zres[0],"+/-",norm1_Zres[1]
     if options.addTop: print "tt normalization after fit: ",norm1_TThad[0],"+/-",norm1_TThad[1]
     if options.fitSignal: print "Signal yields after fit: ",norm1_sig[0],"+/-",norm1_sig[1]
     print
